/*=========================================================================
DO FILE NAME:			sensitivity_analyses_antibiotics.do
...
DESCRIPTION OF FILE:    all infections defined with antibiotics + read code

*=========================================================================*/

use $cleandata\sens_antibiotics, clear

log using $log\antibiotics_cox.log, replace
*st
strate infection_tv, per(1000) 
strate infection_tv, per(1000) output ($results/strate_antibiotics, replace)
...
file open textfile using $results/antibiotics_cox.csv, write replace
...
log using $log/inftype_antibiotics_cox.log, replace
...
capture file close textfile 
*file close textfile
file open textfile_type using $results/antibiotics_cox.csv, write append
...
tab infection_type
drop if infection_type==6 //
tab infection_type

strate infection_tv, per(1000) 
strate infection_tv, per(1000) output ($results/strate_inf_excl, replace)
...
*tempname myfile
capture file close textfile 
file open textfile using $results/infection_exclusion.csv, write replace
file write textfile "sep=;" _n
file write textfile "Effect of infections on dementia" _n _n
file write textfile  ";"   "Number of dementia events" ";" "Person years at risk" ";" "Crude incidence rate (per 1000 person-years)"    
file write textfile  ";"   "Age-adjusted HR* (95% CI)" ";" "Minimally-adjusted HR** (95% CI)" ";" "Fully adjusted HR*** (95% CI)" _n 
